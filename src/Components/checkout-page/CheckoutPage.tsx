...
import { PaymentMethodType } from "../../Store/Enums/Order/PaymentMethodType";
...
import { setCurrentUser } from "../../Store/Slices/authenticateSlice";
import { addOrder } from "../../Store/Thunks/orderThunks";
import { OrderStatusType } from "../../Store/Enums/Order/OrderStatusType";
import { SizeType } from "../../Store/Enums/SizeType";
import { removeAllItems } from "../../Store/Thunks/cartThunks";
        ...
        {cartItems.map((item, index) => {
          return (
            <Box className={styles.item} key={item.cartProductId}>
              ...
              <Typography className={styles.price}>{`${Number(item.priceKg) * Number(item.quantity)
                } lei`}</Typography>
            </Box>
          );
        })}
